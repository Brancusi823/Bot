...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .setDescription("Scoate certificat")
    .addStringOption((option) =>
      option
        .setName("certificat")
        .setDescription("Alege certificatul pe care vrei sa-l scoti")
        .setRequired(true)
        .addChoices(
  ...
  async execute(interaction, client) {
    ...
    try {
        ...
        if (data[0] === membru.user.id) {
          ...
          switch(certificat) {
            case 'certificat_heli': {
              ...
              await membru.roles.remove(process.env.DISCORD_HELI_ROLE);
            ...
            case 'certificat_hs': {
              ...
              await membru.roles.remove(process.env.DISCORD_HS_ROLE);
            ...
            case 'certificat_sniper': {
              ...
              await membru.roles.remove(process.env.DISCORD_Sniper_ROLE);
      ...
      const logEmbed = new EmbedBuilder()
        .setColor('#1fbc9d')
        .setTitle(`Certificat Scos`)
        .setDescription(
          `${membru} i-a fost scos certificatul **${certificat}** pe DOCS de catre ${interaction.user}`
        ).setTimestamp();
      ...
      interaction.editReply({ content: 'Certificat scos cu succes!' })
      
    } catch (error) {
      console.log(`[SCOATE_CERTIFICAT_ERROR]:\n${error}`);
    }
  },
};
